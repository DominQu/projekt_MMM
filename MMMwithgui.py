...
def animate(i):
    a.clear()
    a.plot(model.time, root.page1.model.y)
...
class Page(tk.Frame):
    ...
    def UpdateSim(self):
        ...
        print(self.c_var.get())
        print(self.model.y[2])
        print(self.model.c[2000:2050])
...
class Taylor:
    def __init__(self):
        ...
        self.u = [0 for i in range(self.N)]
        self.c = [0 for i in range(self.N)]
        self.y = [0 for i in range(self.N)]
        self.y1p = [0 for i in range(self.N)]
        self.y2p = [0 for i in range(self.N)]
        self.y3p = [0 for i in range(self.N)]
